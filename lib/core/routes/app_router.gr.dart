...
/// generated route for
/// [BottomPageBuilder]
class BottomRouteBuilder extends PageRouteInfo<void> {
  const BottomRouteBuilder({List<PageRouteInfo>? children})
      : super(
          BottomRouteBuilder.name,
          initialChildren: children,
        );

  static const String name = 'BottomRouteBuilder';
